...
contract RaffleTest is Test {
    ...
    //skipping a test based off of the chain id
    modifier skipFork() {
        ...
        skipFork
    {
        ...
        //testing skill that makes a capture of the event outputs to use them later in the test
        vm.recordLogs();
        raffle.performUpkeep(""); // emit requestId
        Vm.Log[] memory entries = vm.getRecordedLogs();
        bytes32 requestId = entries[1].topics[1];
        ...
        // Assert ***Its good practice to have 1 assert per test, not this much***
