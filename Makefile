-include .env    #if we have this line we supposably don't have to type "source .env" in the terminal
...
#when we put @ infront of the command it hides the actuall command in the terminal (if our private key is going to show, better to use @)